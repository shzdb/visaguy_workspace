...
- [FEAT-003](../features/planned/waflo-correctness/README.md) is sequenced **before** [FEAT-002](../features/planned/multi-company-whatsapp/README.md). Fanning WhatsApp traffic out to more numbers while the rate limiter does not count is an avoidable risk to the Meta account, and both features edit `waflo/messaging/send.py`.
