...
- [`operations/whatsapp-manual-test-plan.md`](operations/whatsapp-manual-test-plan.md) — manual test plan for WhatsApp zone routing, rate limiting, and retry on the dev site.
